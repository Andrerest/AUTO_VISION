...
export default function ModificationCard({ mod, index }) {
  ...
  return (
    ...
    >
      ...
      <h4 className="text-sm font-bold uppercase tracking-tight mb-2">{mod.name}</h4>
      ...
      <div className="border-t border-border pt-3 flex flex-wrap gap-x-4 gap-y-2">
        {mod.power_gain && (
          <div>
            <span className="font-mono text-[10px] text-muted-foreground block">GANANCIA</span>
            <span className="font-mono text-xs text-accent font-medium">{mod.power_gain}</span>
          </div>
        )}
        {mod.difficulty && (
          <div>
            <span className="font-mono text-[10px] text-muted-foreground block">INSTALACION</span>
        ...
        {mod.price_range && (
          <div>
            <span className="font-mono text-[10px] text-muted-foreground block">PRECIO</span>
