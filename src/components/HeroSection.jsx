  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={HERO_IMAGE}
          alt="High-performance sports car in industrial warehouse"
      ...
      <div className="relative max-w-[1400px] mx-auto px-6 md:px-10 w-full py-40">
        ...
        >
          ...
          >
            Explore our curated inventory of performance platforms and precision modifications engineered for every build.
          </motion.p>
